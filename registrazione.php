        ...
        <?php
            ...
            if ($dbconn) {
                ...
                if ($tuple=pg_fetch_array($result, null, PGSQL_ASSOC)) { //funzione che itera tutte le tuple del db e vede se è presente quella richiesta
                    echo "<h1> L'indirizzo email inserito è già registrato, clicca
                         <a href=../rifiuti_ingombranti/login_index.html> qui  </a> per effettuare il login </h1>";
                }
                else {
                    ...
                    if ($data) {
                        ...
                        <a href=../rifiuti_ingombranti/login_index.html> Clicca qui </a>
                            per effettuare il login!</h1>";
                    }
                }
            }
        ?> 
