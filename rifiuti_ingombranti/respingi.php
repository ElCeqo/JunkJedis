...
if ($dbconn) {
        $respinta="Respinta";
        $q5="update prenotazioni set stato='$respinta' where municipio=$1 and oggetto=$2 and via=$3";
        ...
        try {
            ...
            $mail->Body    = 'Ciao '.$nome.' '.$cognome. '! Siamo spiacenti ma la tua richiesta è stata respinta. Per maggiori informazioni, contatta il servizio clienti';
